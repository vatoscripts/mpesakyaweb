<template>
    <div class="content-wrapper">
        <h4 class="content-heading">
            <div>
                M-pesa KYA Portal
                <p class="lead mt-2">Onboard Wakala Recruiter</p>
            </div>
        </h4>
        <div class="col-8 vld-parent" ref="formContainer">
            ...
            >
                <div class="form-group">
                    <label class="text-bold">Phone Number</label>
                    <input
                        name="recruiterPhone"
                        class="form-control"
                        type="text"
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        v-model="fields.recruiterNIN"
                    />
                    <div
                        v-if="errors && errors.recruiterNIN"
                        class="text-danger"
                    >
                        {{ errors.recruiterNIN[0] }}
                    </div>
                </div>
                ...
                >
                    <em class="fa mr-2 fas fa-arrow-right"></em> Onboard
                    Recruiter
                </button>
            </form>
        </div>
            ...
            axios
                ...
                .catch(error => {
                    ...
                    if (error.response.status === 422) {
                        ...
                        this.message =
                            "Something went wrong while onboarding recruiter !";
                    }
                });
        }
    }
